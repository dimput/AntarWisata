...
<div style={{ paddingTop: "130px", marginBottom: "100px"}}>
    <div style={{backgroundImage: "linear-gradient(45deg, rgba(72,44,191,1) 0%, rgba(106,198,240,1)100%)",width:"100%",height:80,position:"absolute", top:"0px"}}></div>
                    <div style={{width:"80%",margin:"0 auto", fontSize:"36px", textAlign:"Center",fontWeight:"900"}} dangerouslySetInnerHTML={{__html:this.getJudul()}}></div>
                    <br/>
                    <div style={{width:"80%",margin:"0 auto"}} dangerouslySetInnerHTML={{__html:this.getKontent()}}>
                    </div>
